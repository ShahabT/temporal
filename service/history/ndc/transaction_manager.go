...
func (r *transactionMgrImpl) backfillWorkflowEventsReapply(
	...
	targetWorkflowActiveCluster := targetWorkflow.GetMutableState().GetNamespaceEntry().ActiveClusterName(namespace.BusinessID{ID: targetWorkflow.GetMutableState().GetExecutionInfo().WorkflowId})
